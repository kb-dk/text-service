...
# Added authors and periods to the index presenter, so that it doesn't return null. It's a bug in blacklight 7.0.1. If it fixed in the next version we should remove this file from our customized repository.
    when 'index', 'authors', 'periods'
